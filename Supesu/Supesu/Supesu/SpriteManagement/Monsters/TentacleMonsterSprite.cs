...
{
    class TentacleMonsterSprite : Sprite
    {
        ...
        {
            Level.AddBullet(new NormalEnemyBullet(new Vector2(0, -1), new Vector2((this.position.X + frameSize.X / 2) - 2, this.position.Y + 20), 0.55f, new Rectangle(0, 0, 12, 12), game.Content, 6));
        }
